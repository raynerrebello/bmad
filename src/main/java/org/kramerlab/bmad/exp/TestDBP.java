...
public class TestDBP {
    public static void main(String[] args) throws Exception {
        ...
        double coverage = 0;
        BooleanMatrixDecomposition algorithm = BooleanMatrixDecomposition.DBP;
            ...
            for (int i = 0; i < listOfFiles.length; i++) {
                if (listOfFiles[i].isFile()) {
                    ...
                    for (int k : kValues) {
                        ...
                        String filename = String.format("./src/main/java/org/kramerlab/bmad/exp/dbpout/k_%d_r_%d_%s.txt",k,(j+1),name);
