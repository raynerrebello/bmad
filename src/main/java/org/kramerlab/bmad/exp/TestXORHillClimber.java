...
public class TestXORHillClimber {
            ...
            for (int i = 0; i < listOfFiles.length; i++) {
                if (listOfFiles[i].isFile()) {
                    ...
                    for (int k : kValues) {
                        ...
                        Tuple<BooleanMatrix, BooleanMatrix> ans = hillClimber.decomposition(T, k, true, 10,8);
                        ...
                        String filename = String.format(".\\src\\main\\java\\org\\kramerlab\\bmad\\exp\\hcxorout\\k_%d_r_%d_%s.txt",k,(j+1),name);
